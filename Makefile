...
allnocompression:
	uglifyjs src/*.js src/ajax/*.js src/fingerprint/*.js vast/adhese-vast.js -b -v -o dist/adhese.min.js

novastnoajax:
	uglifyjs src/*.js -m -v -c -o dist/adhese.min.js

novast:
	uglifyjs src/*.js src/ajax/*.js src/fingerprint/*.js -m -v -c -o dist/adhese.min.js
...
debug:
	uglifyjs src/*.js src/ajax/*.js vast/adhese-vast.js -b -v -o dist/adhese.debug.js
