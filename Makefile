all:
	uglifyjs src/*.js src/ajax/*.js src/detection/*.js src/fingerprint/*.js src/events/*.js src/rtb/*.js vast/adhese-vast.js src/safeframe/SafeFrame.js src/safeframe/js/lib/base.js src/safeframe/js/host/host.js src/safeframe/js/lib/boot.js -m -c -o dist/adhese.min.js
...
debug:
	cat src/*.js src/ajax/*.js src/detection/*.js src/visible/*.js src/events/*.js src/rtb/*.js vast/adhese-vast.js src/safeframe/SafeFrame.js src/safeframe/js/lib/base.js src/safeframe/js/host/host.js src/safeframe/js/lib/boot.js > dist/adhese.debug.js
